        ...
        renderItem = function(cell, uuid, data)
            ...
            if name then
                ...
                local spellInfoFields = {
                    { key = "id", label = "ID" }, { key = "fullName", label = "Name" }, { key = "spellType", label = "Spell Type" },
                    { key = "spellSchool", label = "Spell School" }, { key = "useCosts", label = "Use Costs" }, { key = "level", label = "Level" },
                    { key = "cooldown", label = "Cooldown" }, { key = "modName", label = "Mod Name" },
                }
